...
SOL86_CFLAGS	= -O3
MACOS_CFLAGS	= -g -Wall -Wno-unused-but-set-variable
...
# dbgen_tpcd = cp dsdgen dbgen_tpcd, dbgen_tpcd is just a copy of dsdgen for convenience
dbgen_tpcd: $(PROG1)
	cp $(PROG1) $@
# dsqgen
$(PROG2): $(OBJ2)
...
clean:
	-rm -f $(PROGS) $(OBJ) $(JUNK) $(IDX) dbgen_tpcd$(EXE)
.ctags_updated: $(SRC)
